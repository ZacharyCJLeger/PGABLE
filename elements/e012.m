function e = e012(model)
    ...
    switch model
        ...
        case "CGA"
            error('Cannot create e012 element as it does not exist in the CGA model.')
        case "OGA"
            error('Cannot create e012 element as it does not exist in the OGA model.')
        otherwise
